...
public abstract class JCardBoard
    extends JBoard
    ...
    public void initializeVirtualImage(){
        ...
        vg.setColor(new Color(0,0,NO_CARD));
        vg.fillRect(0,0,w,h);
    ...
    private void paintHand(final Graphics2D g,
        ...
        for(int i=0;i<numberOfCardsAtHand;i++){
            ...
            drawCard(card,g,shape,
                     (selected!=NO_CARD) && (selected == handCard.virtualColor),
